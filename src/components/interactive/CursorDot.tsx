...
export default function CursorDot() {
  ...
  return (
    <div
      ref={dotRef}
      aria-hidden="true"
      className="bg-brand-gold pointer-events-none fixed top-0 left-0 z-[200] hidden h-3 w-3 rounded-full shadow-[0_0_18px_rgba(245,200,66,0.55)] transition-[background-color,box-shadow] duration-200 lg:block"
      style={{
